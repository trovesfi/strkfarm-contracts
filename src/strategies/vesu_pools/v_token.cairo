...
mod VToken {
    ...
    fn constructor(
        ...
        self.erc20._approve(get_contract_address(), extension, Bounded::MAX);
        IERC20Dispatcher { contract_address: asset }.approve(self.singleton().contract_address, Bounded::MAX);
    ...
    impl VToken of super::IVToken<ContractState> {
        ...
        fn approve_extension(ref self: ContractState) {
            self.erc20._approve(get_contract_address(), self.extension.read(), Bounded::MAX);
        }
    ...
    impl IERC4626 of super::IERC4626<ContractState> {
        ...
        fn max_deposit(self: @ContractState, receiver: ContractAddress) -> u256 {
            ...
            let room: u256 = Bounded::MAX - asset_config.total_collateral_shares;
        ...
        fn max_mint(self: @ContractState, receiver: ContractAddress) -> u256 {
            ...
            Bounded::MAX - asset_config.total_collateral_shares
        }
